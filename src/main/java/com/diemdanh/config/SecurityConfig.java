...
//    }
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.csrf().disable()
                ...
                .authorizeRequests().antMatchers("/files/images/*","/authenticate","/swagger-ui/","/swagger-ui/**","/v2/**","/swagger-resources/**").permitAll()
        ...
        httpSecurity.addFilterAfter(corsFilter, SessionManagementFilter.class);
